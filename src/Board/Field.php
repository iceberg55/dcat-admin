...
class Field implements Renderable
{
     ...
     * @return $this
     */
    public function setParent(ModelHolder $parent)
    {
        $this->parent = $parent;
...
HTML;
    ...
    public function bool(array $map = [], $default = false)
    {
        return $this->unescape()->as(function ($value) use ($map, $default) {
            ...
            return $bool ? '<i class="feather icon-check font-md-2 font-w-600 text-primary"></i>' : '<i class="fas fa-ban font-md-1 font-w-600 text-70"></i>';
        });
    }
